...
describe('SchemaManager', () => {
  ...
  describe('captureSchema', () => {
    ...
    it('should handle capture errors', async () => {
      ...
      await expect(
        schemaManager.captureSchema('testdb', {
          type: 'postgresql',
          host: 'localhost',
          database: 'testdb',
        } as DatabaseConfig)
    ...
    it('should handle missing adapter', async () => {
      ...
      ).rejects.toThrow("No adapter found for database 'testdb'");
    });
  ...
  describe('getSchemaStatistics', () => {
    it('should return statistics for cached schemas', async () => {
      ...
      const schema2 = {
        ...
        database: 'db2',
        type: 'mysql',
        summary: { table_count: 2, view_count: 0, total_columns: 4 },
      };
