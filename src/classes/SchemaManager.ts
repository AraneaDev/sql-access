 ...
 */
 ...
 private isValidSchema(schema: any): schema is DatabaseSchema {
 return (
 schema &&
 typeof schema === 'object' &&
 typeof schema.database === 'string' &&
 typeof schema.type === 'string' &&
 typeof schema.captured_at === 'string' &&
 typeof schema.tables === 'object' &&
 typeof schema.views === 'object' &&
 schema.summary &&
 typeof schema.summary.table_count === 'number' &&
 typeof schema.summary.view_count === 'number' &&
 typeof schema.summary.total_columns === 'number'
 );
 }
