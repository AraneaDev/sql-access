 ...
 */
 ...
 recommendations.push(' CRITICAL: Query took over 5 seconds - requires immediate optimization');
 ...
 if (joinCount > 3) {
 recommendations.push(' COMPLEX: Multiple JOINs detected - ensure proper indexing on join columns');
 } else if (joinCount > 0) {
 ...
 */
 ...
 recommendations.push('[INFO] SQLITE: Run ANALYZE command periodically to update query planner statistics');
 }
}
