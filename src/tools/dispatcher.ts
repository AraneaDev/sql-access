...
import { handleSqlQuery, handleBatchQuery, handleAnalyzePerformance } from './handlers/query-handlers.js';
import { handleGetSchema, handleRefreshSchema, handleListDatabases, handleTestConnection } from './handlers/schema-handlers.js';
import {
 handleAddDatabase, handleUpdateDatabase, handleRemoveDatabase,
