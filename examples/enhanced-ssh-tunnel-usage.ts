...
async function advancedSSHTunnelExample() {
  ...
  try {
    ...
    if (portAvailability.available) {
      ...
      console.log(`⚠️ Preferred port ${preferredPort} is not available: ${portAvailability.reason}`);
...
async function multiDatabaseTunnelExample() {
  ...
  try {
    ...
    console.log('\n⏱️ Keeping tunnels active for 10 seconds...');
...
async function errorHandlingExample() {
  ...
  try {
    ...
    console.log('⚠️ Error checking port 80:', (error as Error).message);
  }
...
async function runExamples() {
  ...
  try {
    console.log('1️⃣ Basic SSH Tunnel Example');
    console.log('=' .repeat(50));
    await basicSSHTunnelExample();

    console.log('\n\n2️⃣ Advanced Usage Example');
    console.log('=' .repeat(50));
    await advancedSSHTunnelExample();

    console.log('\n\n3️⃣ Multiple Database Tunnels');
    console.log('=' .repeat(50));
    await multiDatabaseTunnelExample();

    console.log('\n\n4️⃣ Port Conflict Resolution');
    console.log('=' .repeat(50));
